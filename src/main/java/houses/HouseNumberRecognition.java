 ...
 * @author saudet
 */
public class HouseNumberRecognition {
    private static final Logger log = LoggerFactory.getLogger(HouseNumberRecognition.class);
    ...
    public static void main(String[] args) throws java.lang.Exception {
        ...
        String modelFilename = "data/svhnmodel.zip";
